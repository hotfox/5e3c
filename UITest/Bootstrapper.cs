...
namespace UITest
{
    public class Bootstrapper:MefBootstrapper
    {
        ...
        protected override void ConfigureAggregateCatalog()
        {
            ...
            AggregateCatalog.Catalogs.Add(new AssemblyCatalog(typeof(TestManageModule).Assembly));
        ...
        private const string designDir = @".\Design"; 
        //@"\\CH3UW1050\Temporary Transfer\cheng Dewi\Desgin";
    }
}
